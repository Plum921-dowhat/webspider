...
def test_compute_by_source_deltas():
    ...
    assert out["devto"] == {"produced_delta": 52, "stored_delta": 35}
    assert out["rss"] == {"produced_delta": 0, "stored_delta": 2}
    assert out["stackexchange"] == {"produced_delta": 1, "stored_delta": 0}
...
def test_compute_by_source_first_sample_all_zeroes():
    ...
    assert out["devto"] == {"produced_delta": 0, "stored_delta": 0}
